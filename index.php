<?php
// Vercel પર સેસન્સ ચલાવવા માટે આ પાથ જરૂરી છે
session_save_path('/tmp');
session_start();
include('database/connection.php');

// કેશિંગ લોજિક દૂર કરીને ડાયરેક્ટ ક્વેરી રન કરવાનું ફંક્શન
function get_cached_query_result($conn, $sql, $types, $params, $cache_file, $cache_time_seconds) {
    // ફાઈલ સિસ્ટમનો ઉપયોગ બંધ કર્યો છે, સીધું ડેટાબેઝમાંથી ડેટા લેશે
...
// --- પ્રોજેક્ટ સેટિંગ્સ અને કેટેગરીઝ ---
...
$all_categories_data = get_cached_query_result($conn, $categories_sql, null, [], '', 0);
$all_categories = [];
